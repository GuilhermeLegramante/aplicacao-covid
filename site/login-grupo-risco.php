...
<body>
    ...
    <!-- /bradcam_area  -->
     ...
     <div class="container">
        <div class="row">
            <div class="col-md-6">
                <section class="prising_area minus_padding">
                    <div class="container" style="align-items: center;">
                        <h2>Acesso - Grupo de Risco</h2>
                        <br>
                        <form id="form-login-vulneravel" onclick="#">
                            <div class="form-group" style="max-width: 300px;">
                                <input type="text" class="form-control" id="inputCPF" placeholder="CPF (apenas números)" maxlength="11" required>
                            </div>
                            <div class="form-group" style="max-width: 300px;">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="section_title text-center wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".5s">
                                    ...
                                    <a href="cadastro-grupo-risco.php">Cadastrar grupo de risco</a>
                                </div>
                            </div>
                        </div>
                    </div>
