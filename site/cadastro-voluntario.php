...
<body>
    ...
    <section class="contact-section">
        <div class="container">
            <br>
            <h1 style="text-align: center;">Dados do Voluntário</h1>
            <br>
            <form id="form-voluntario" method="POST" action="../controller/CadastroVoluntarioController.php" enctype="multipart/form-data">
                <div class="">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputCpf" placeholder="CPF" name="cpf" pattern="\d{11}" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <label class="radio-inline"><input type="radio" name="raioAtuacao" value="3"> Até 3km</label>
                        </div>
                        <div class="col-md-2">
                            <label class="radio-inline"><input type="radio" name="raioAtuacao" value="5"> Até 5km</label>
                        </div>
                        <div class="col-md-2">
                            <label class="radio-inline"><input type="radio" name="raioAtuacao" value="10"> Até 10km</label>
                        </div>
                        <div class="col-md-2">
